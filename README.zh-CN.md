...
<a href="https://github.com/joshan-kana/FineTune/releases"><img src="assets/download-badge.svg" alt="Fork macOS 版本" height="48"/></a>

<br clear="all"/>

<p align="center">
  <a href="https://github.com/joshan-kana/FineTune/releases"><img src="https://img.shields.io/github/v/release/joshan-kana/FineTune?style=for-the-badge&labelColor=1c1c1e&color=0A84FF&logo=github&logoColor=white" alt="Fork 版本"></a>
  <a href="https://github.com/joshan-kana/FineTune/releases"><img src="https://img.shields.io/github/downloads/joshan-kana/FineTune/total?style=for-the-badge&labelColor=1c1c1e&color=3a3a3c" alt="Fork 下载量"></a>
...
**Fork 发布版** —— [浏览已发布的安装包](https://github.com/joshan-kana/FineTune/releases)。发布包使用 ad-hoc 签名，未经过公证（notarization）。
...
FineTune 永远免费且开源。本仓库是基于 [上游 FineTune 项目](https://github.com/ronitsingh10/FineTune) 的维护分支；便携的 Audio Unit 工作会在源码和提交历史中保留署名。
